        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-stretch gap-10 lg:grid-cols-2 lg:gap-12">
            <div>
              ...
              <h2 className="font-display text-section font-bold leading-tight tracking-tight text-dark">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link href={`/${locale}/kurumsal/sertifikalar`} className="inline-flex items-center gap-2 rounded-xl border border-ink/15 bg-[#f8f5ed] px-6 py-3 text-sm font-semibold text-secondary transition-all duration-200 hover:border-primary/30 hover:text-primary">
                  {t.ourCertificates}
                </Link>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
            <div className="relative order-2 lg:order-1">
              <div className="absolute -top-3 -left-3 h-full w-full rounded-2xl border border-primary/25" />
              <Image src="/images/uretim.png" alt={t.factoryAlt} width={640} height={427} className="relative rounded-2xl border border-ink/10 object-cover shadow-[0_16px_34px_-24px_rgba(15,20,30,0.38)]" />
            </div>
            <div className="order-1 lg:order-2">
              ...
              <ul className="mt-7 space-y-3 rounded-2xl border border-ink/10 bg-[#f8f5ed] p-5">
      ...
      <section className="bg-[#ecebe6] py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            ...
            <h2 className="font-display text-section font-bold tracking-tight text-dark">{t.areasTitle}</h2>
            <p className="mx-auto mt-4 max-w-2xl text-base text-secondary/65">{t.areasDesc}</p>
          </div>
          <div className="grid gap-8 md:grid-cols-2">
            <div className="group relative overflow-hidden rounded-2xl border border-ink/10 bg-[#f8f5ed] p-8 transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-[0_16px_30px_-22px_rgba(15,20,30,0.34)]">
              <div className="absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-[#1d2f4d]/90 via-primary/75 to-[#90a5bd]/75" />
              <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-2xl border border-ink/10 bg-[#fbf9f3] text-primary transition-colors duration-200 group-hover:border-primary/30 group-hover:bg-primary group-hover:text-white">
      ...
      <section className="relative overflow-hidden bg-dark py-18 sm:py-20">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 text-center">
            ...
            <h2 className="font-display text-section font-bold tracking-tight text-white">{t.whyTitle} <span className="text-primary">NOVVES</span>?</h2>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {t.reasons.map((reason: { title: string; desc: string }, i: number) => (
              <div key={reason.title} className="group rounded-2xl border border-white/10 bg-white/[0.04] p-7 transition-all duration-200 hover:border-primary/30 hover:bg-white/[0.08]">
