  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-dark py-18 sm:py-20">
        <div className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full opacity-[0.09]" style={{ background: "radial-gradient(circle, #ef5f17 0%, transparent 70%)" }} />
        <div className="pointer-events-none absolute -left-24 -bottom-24 h-72 w-72 rounded-full opacity-[0.08]" style={{ background: "radial-gradient(circle, #ef5f17 0%, transparent 70%)" }} />
        <div className="pointer-events-none absolute inset-0 blueprint-grid-light opacity-[0.08]" />
