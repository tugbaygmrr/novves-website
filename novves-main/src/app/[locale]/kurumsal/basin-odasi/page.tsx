...
export async function generateMetadata({
  ...
  return corporateDetailMetadata(locale, "basinOdasi");
}
  ...
  return (
    <main>
      <section className="relative flex min-h-[540px] items-end overflow-hidden">
        <Image src="/images/page-hero/ekibimiz.jpg" alt="" fill priority className="object-cover" sizes="(max-width: 768px) 100vw, 1280px" />
      ...
      <section className="bg-[#ecebe6] py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-12 max-w-3xl rounded-2xl border border-ink/10 bg-[#f8f5ed] p-8 text-center">
            ...
            <h2 className="mt-6 font-display text-card font-bold text-dark">{t.comingSoon}</h2>
