  ...
  return (
    <main>
      <section className="relative overflow-hidden bg-dark py-28">
        <Image src="/images/page-hero/ceo.jpg" alt="" fill className="object-cover opacity-30" priority />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-dark via-dark/70 to-dark/50" />
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg leading-relaxed text-white/50">{t.heroDesc}</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-16 lg:grid-cols-3">
            <div className="lg:col-span-1">
              <div className="sticky top-28">
                <div className="relative">
                  <div className="absolute -top-3 -left-3 h-full w-full rounded-2xl border-2 border-primary/20" />
                ...
                <div className="mt-8 space-y-3">
                  {t.highlights.map((h: { value: string; label: string }, i: number) => (
                    <div key={h.label} className="flex items-center gap-4 rounded-xl border border-gray-100 bg-gray-50 px-5 py-4">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary">{highlightIcons[i]}</div>
                      <div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-6 text-base leading-8 text-secondary/75">
                ...
                <blockquote className="my-10 rounded-r-2xl border-l-4 border-primary bg-gray-50 py-7 pl-8 pr-6">
              ...
              <div className="mt-12 flex flex-wrap gap-4 border-t border-gray-100 pt-10">
                <Link href={`/${locale}/kurumsal/biz-kimiz`} className="inline-flex items-center gap-2 rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-secondary transition-all duration-200 hover:border-primary/30 hover:text-primary">
                ...
                <Link href={`/${locale}/kurumsal/ekibimiz`} className="inline-flex items-center gap-2 rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-secondary transition-all duration-200 hover:border-primary/30 hover:text-primary">
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" /></svg>
                  {t.linkTeam}
                </Link>
                <Link href={`/${locale}/iletisim`} className="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-[#e55a28] hover:shadow-md">
