          ...
          <div className="grid gap-10 lg:grid-cols-3 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-9 flex flex-wrap gap-3 border-t border-ink/10 pt-8">
                ...
                <Link href={`/${locale}/iletisim`} className="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition-all duration-200 hover:bg-primary-deep hover:shadow-xl hover:shadow-primary/30">
