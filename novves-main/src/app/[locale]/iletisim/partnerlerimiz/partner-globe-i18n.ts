...
const CITY_BY_LOCALE: Record<Locale, Record<Locale, string>> = {
  tr: { tr: "İstanbul", en: "Londra", ru: "Moskova", ar: "Riyad", de: "Berlin", it: "Roma", fr: "Paris", az: "Bakü", kk: "Astana", tg: "Duşanbe", es: "Madrid", zh: "Pekin", ur: "İslamabad", lt: "Vilnius", pl: "Varşova" },
  en: { tr: "Istanbul", en: "London", ru: "Moscow", ar: "Riyadh", de: "Berlin", it: "Rome", fr: "Paris", az: "Baku", kk: "Astana", tg: "Dushanbe", es: "Madrid", zh: "Beijing", ur: "Islamabad", lt: "Vilnius", pl: "Warsaw" },
  ru: { tr: "Стамбул", en: "Лондон", ru: "Москва", ar: "Эр-Рияд", de: "Берлин", it: "Рим", fr: "Париж", az: "Баку", kk: "Астана", tg: "Душанбе", es: "Мадрид", zh: "Пекин", ur: "Исламабад", lt: "Вильнюс", pl: "Варшава" },
  ar: { tr: "إسطنبول", en: "لندن", ru: "موسكو", ar: "الرياض", de: "برلين", it: "روما", fr: "باريس", az: "باكو", kk: "أستانا", tg: "دوشنبه", es: "مدريد", zh: "بكين", ur: "إسلام آباد", lt: "فيلنيوس", pl: "وارسو" },
  de: { tr: "Istanbul", en: "London", ru: "Moskau", ar: "Riad", de: "Berlin", it: "Rom", fr: "Paris", az: "Baku", kk: "Astana", tg: "Duschanbe", es: "Madrid", zh: "Peking", ur: "Islamabad", lt: "Wilna", pl: "Warschau" },
  it: { tr: "Istanbul", en: "Londra", ru: "Mosca", ar: "Riad", de: "Berlino", it: "Roma", fr: "Parigi", az: "Baku", kk: "Astana", tg: "Dushanbe", es: "Madrid", zh: "Pechino", ur: "Islamabad", lt: "Vilnius", pl: "Varsavia" },
  fr: { tr: "Istanbul", en: "Londres", ru: "Moscou", ar: "Riyad", de: "Berlin", it: "Rome", fr: "Paris", az: "Bakou", kk: "Astana", tg: "Douchanbé", es: "Madrid", zh: "Pékin", ur: "Islamabad", lt: "Vilnius", pl: "Varsovie" },
  az: { tr: "İstanbul", en: "London", ru: "Moskva", ar: "Ər-Riyad", de: "Berlin", it: "Roma", fr: "Paris", az: "Bakı", kk: "Astana", tg: "Düşənbə", es: "Madrid", zh: "Pekin", ur: "İslamabad", lt: "Vilnüs", pl: "Varşava" },
  kk: { tr: "Стамбул", en: "Лондон", ru: "Мәскеу", ar: "Эр-Рияд", de: "Берлин", it: "Рим", fr: "Париж", az: "Баку", kk: "Астана", tg: "Душанбе", es: "Мадрид", zh: "Пекин", ur: "Исламабад", lt: "Вильнюс", pl: "Варшава" },
  tg: { tr: "Истанбул", en: "Лондон", ru: "Маскав", ar: "Риёз", de: "Берлин", it: "Рим", fr: "Париж", az: "Боку", kk: "Остона", tg: "Душанбе", es: "Мадрид", zh: "Пекин", ur: "Исломобод", lt: "Вилнюс", pl: "Варшава" },
  es: { tr: "Estambul", en: "Londres", ru: "Moscú", ar: "Riad", de: "Berlín", it: "Roma", fr: "París", az: "Bakú", kk: "Astaná", tg: "Dusambé", es: "Madrid", zh: "Pekín", ur: "Islamabad", lt: "Vilna", pl: "Varsovia" },
  zh: { tr: "伊斯坦布尔", en: "伦敦", ru: "莫斯科", ar: "利雅得", de: "柏林", it: "罗马", fr: "巴黎", az: "巴库", kk: "阿斯塔纳", tg: "杜尚别", es: "马德里", zh: "北京", ur: "伊斯兰堡", lt: "维尔纽斯", pl: "华沙" },
  ur: { tr: "استنبول", en: "لندن", ru: "ماسکو", ar: "ریاض", de: "برلن", it: "روم", fr: "پیرس", az: "باکو", kk: "آستانہ", tg: "دوشنبے", es: "میڈرڈ", zh: "بیجنگ", ur: "اسلام آباد", lt: "ولنیئس", pl: "وارسا" },
  lt: { tr: "Stambulas", en: "Londonas", ru: "Maskva", ar: "Rijadas", de: "Berlynas", it: "Roma", fr: "Paryžius", az: "Baku", kk: "Astana", tg: "Dušanbė", es: "Madridas", zh: "Pekinas", ur: "Islamabadas", lt: "Vilnius", pl: "Varšuva" },
  pl: { tr: "Stambuł", en: "Londyn", ru: "Moskwa", ar: "Rijad", de: "Berlin", it: "Rzym", fr: "Paryż", az: "Baku", kk: "Astana", tg: "Duszanbe", es: "Madryt", zh: "Pekin", ur: "Islamabad", lt: "Wilno", pl: "Warszawa" },
};
