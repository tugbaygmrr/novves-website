...
export async function generateMetadata({
  ...
  return productCategoryMetadata(locale, "sogutmaVeIsitma");
}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 flex items-end gap-6">
            <div>
              ...
              <h2 className="mt-2 font-eurostile text-section font-bold tracking-tight text-dark">{s.productFamilies}</h2>
            </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {t.products.map((product: { name: string; type: string; subModels: string[] }, i: number) => (
              ...
              >
                ...
                <h3 className="font-eurostile text-card-sm font-bold tracking-tight text-dark">{product.name}</h3>
