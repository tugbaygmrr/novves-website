        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-2.5 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
            {t.alpaca.subModels.map((model: string) => (
              <div
                key={model}
                className="group relative overflow-hidden rounded-xl border border-ink/10 bg-[#f5f2eb] px-4 py-3.5 shadow-[0_10px_24px_-24px_rgba(15,20,30,0.22)] transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/25 hover:bg-[#f8f5ed] hover:shadow-[0_16px_30px_-22px_rgba(15,20,30,0.3)]"
              >
          ...
          <div className="mt-12 flex flex-wrap gap-3">
            <Link
              ...
              className="btn-3d btn-3d-dark group inline-flex items-center gap-3 rounded-xl border border-[#1d2f4d]/25 bg-[#1d2f4d] px-7 py-4 text-sm font-bold text-white transition-all duration-300 hover:border-primary hover:bg-primary hover:shadow-xl hover:shadow-primary/25"
            >
