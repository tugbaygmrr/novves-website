        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="mb-9 flex items-end gap-4">
            <div>
              ...
              <h3 className="mt-1 font-eurostile text-card-sm font-bold text-dark">{t.documentTypes.title}</h3>
            </div>
            <div className="hidden h-px flex-1 bg-ink/10 sm:block" />
          </div>
          <div className="grid gap-4 sm:grid-cols-3">
            {t.documentTypes.items.map((doc: { title: string; description: string }) => (
              <div key={doc.title} className="group relative overflow-hidden rounded-xl border border-ink/10 bg-[#f5f2eb] p-6 transition-all duration-300 hover:border-primary/25 hover:bg-[#f8f5ed] hover:shadow-[0_16px_30px_-22px_rgba(15,20,30,0.3)]">
      ...
      <section className="relative overflow-hidden bg-dark py-18 sm:py-20">
        ...
        <div className="relative mx-auto max-w-2xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link href={`/${locale}/iletisim`} className="inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition-all duration-300 hover:bg-primary-deep hover:shadow-xl hover:shadow-primary/30">
              {t.cta.contactForm}
