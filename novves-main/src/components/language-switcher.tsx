  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`inline-flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-fine font-medium transition-all duration-150 md:min-h-[44px] md:px-4 md:py-2 ${
          inverted
