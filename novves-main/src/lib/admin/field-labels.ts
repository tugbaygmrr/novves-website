...
export const PRODUCT_SECTION_LABELS: Record<string, string> = {
  ...
  tavukcuFanlari: "Tavukçu Fanları",
  tozToplamaUniteleri: "Toz Toplama Üniteleri",
  menfezPanjurlar: "Menfez ve Panjurlar",
  filtreler: "Filtreler",
  titresimIzolatorleri: "Titreşim İzolatörleri",
  otomasyonPanolari: "Otomasyon Panoları",
  plcOtomasyon: "PLC",
  sensorler: "Sensörler",
  kontrolKartlari: "Kontrol Kartları",
  zamanlamaKontrol: "Zamanlama ve Kontrol",
  gucElektronigi: "Güç Elektroniği",
};
