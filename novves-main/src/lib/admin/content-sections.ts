...
export const ADMIN_PAGE_GROUPS: AdminPageGroup[] = [
  {
    ...
    sections: [
      ...
      { key: "pillars", label: "3 Sutun" },
      { key: "engineeringShowcase", label: "Muhendislik Vitrin" },
      { key: "engineeringPillarsSection", label: "Muhendislik Sutunlari" },
      { key: "midCta", label: "Orta CTA" },
      { key: "homeBands", label: "Ana Sayfa Bantlari" },
      { key: "productCategories", label: "Urun Kategorileri" },
      { key: "pageChrome", label: "Sayfa Kromu" },
      { key: "solutionCarouselByHref", label: "Cozum Karuseli" },
      { key: "productCategoryBlurbs", label: "Kategori Aciklamalari" },
      { key: "productCategoryFeatures", label: "Kategori Ozellikleri" },
      { key: "catalogPreview", label: "Katalog Onizleme" },
      { key: "certificatePreview", label: "Sertifika Onizleme" },
      { key: "companyProfileSection", label: "Sirket Profili" },
      { key: "companyProfileCards", label: "Profil Kartlari" },
      { key: "referencePreview", label: "Referans Onizleme" },
  ...
  },
  {
    ...
    sections: [
      ...
      { key: "solutionDetail", label: "Cozum Detay Ortak" },
    ],
  },
  {
    file: "products",
  ...
  },
  {
    ...
    sections: [
      { key: "dumanIsiTahliye", label: "Duman ve Isi Tahliye" },
      { key: "konforIklimlendirme", label: "Konfor Iklimlendirme" },
      { key: "hijyenikFiltrasyon", label: "Hijyenik Filtrasyon" },
      { key: "endustriyelHavaYonetimi", label: "Endustriyel Hava" },
      { key: "hayvancilikTesisleri", label: "Hayvancilik Tesisleri" },
      { key: "trafoEnerjiOdalari", label: "Trafo/Enerji Odalari" },
      { key: "seraTarimsal", label: "Sera ve Tarimsal" },
      { key: "atexPatlamaKoruma", label: "ATEX Patlama Koruma" },
      { key: "akilliOtomasyon", label: "Akilli Otomasyon" },
      { key: "konutHavalandirma", label: "Konut Havalandirma" },
      { key: "marinOffshore", label: "Marin ve Offshore" },
      { key: "projeBazliOzelImalat", label: "Proje Bazli Imalat" },
      { key: "cfdDanismanlik", label: "CFD Danismanlik" },
    ],
  },
  {
    file: "services",
    ...
    sections: [
      { key: "genelBakis", label: "Genel Bakis" },
      ...
      { key: "yerindeKesif", label: "Yerinde Kesif" },
      { key: "fanSecimi", label: "Fan Secimi" },
      { key: "bakimPerformans", label: "Bakim ve Performans" },
      { key: "egitimDanismanlik", label: "Egitim ve Danismanlik" },
    ],
  },
  {
    file: "corporate",
  ...
  },
  {
    ...
    sections: [
      { key: "main", label: "Iletisim Sayfasi" },
      { key: "iletisimHub", label: "Iletisim Hub" },
  ...
  },
  {
    ...
    sections: [
      ...
      { key: "co2", label: "CO2" },
      { key: "geriDonusum", label: "Geri Donusum" },
    ],
  },
  {
    file: "technical",
    ...
    sections: [
      { key: "blog", label: "Blog" },
      { key: "dokumanKutuphanesi", label: "Dokuman Kutuphanesi" },
      { key: "fanSecici", label: "Fan Secici" },
  ...
  },
  {
    ...
    sections: [
      ...
      { key: "titleHighlight", label: "Baslik Vurgu" },
      { key: "desc", label: "Aciklama" },
      { key: "sectionLabel", label: "Bolum Etiketi" },
      { key: "sectionTitle", label: "Bolum Basligi" },
