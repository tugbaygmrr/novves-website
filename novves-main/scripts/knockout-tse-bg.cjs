/**
 * public/images/certificates/TSE.png — siyah zemin + koyu AA kenarını şeffaf yapar (kırmızı / beyaz korunur).
 * node scripts/knockout-tse-bg.cjs
 */
const fs = require("fs");
...
const input = path.join(__dirname, "../public/images/certificates/TSE.png");
...
async function main() {
  ...
  const tmp = path.join(__dirname, "../public/images/certificates/TSE.tmp.png");
  ...
  console.log("TSE.png güncellendi. Köşe lum≈", cornerLum.toFixed(1), "şeffaf:", n, input);
}
