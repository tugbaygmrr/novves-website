/**
 * public/images/certificates/ENEC.png — dış siyah zemini şeffaf yapar (köşelerden BFS: içteki siyah EN maviyle çevrili olduğu için korunur).
 * node scripts/knockout-enec-bg.cjs
 */
const fs = require("fs");
...
const input = path.join(__dirname, "../public/images/certificates/ENEC.png");
...
async function main() {
  ...
  const tmp = path.join(__dirname, "../public/images/certificates/ENEC.tmp.png");
  ...
  console.log("ENEC.png güncellendi (kenardan siyah zemin). Şeffaf piksel:", n, input);
}
